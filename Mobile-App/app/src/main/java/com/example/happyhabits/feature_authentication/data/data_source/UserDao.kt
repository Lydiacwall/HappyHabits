...
class UserDao: IUserDao {
    val userList: List<User> = listOf(User("Miltos", "Tsolkas", "yuriuser", "tsolkas@gmail.com", Type.CLIENT, birthDate = "29/03/2002"),
        User("Miltos", "Tsolkas", "yuridoctor", "tsolkas@gmail.com", Type.DOCTOR, birthDate = "29/03/2002"))
