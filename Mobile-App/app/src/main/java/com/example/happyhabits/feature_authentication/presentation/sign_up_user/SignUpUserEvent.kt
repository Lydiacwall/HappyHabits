...
sealed class SignUpUserEvent {
    data class AddUser(val firstName: String, val lastName: String, val password: String, val verifyPassword: String, val birthdate: String, val speciality: String = "None"): SignUpUserEvent()
}