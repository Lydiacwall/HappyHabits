...
| ![Medication details](./Mobile-App/screenshots2/log_habit/medication_details_screen.png) | ![Medication](./Mobile-App/screenshots2/log_habit/medication_screen.png) | ![Choose Symptom](./Mobile-App/screenshots2/log_habit/one_symptom_screen.png) | ![Remove Medication](./Mobile-App/screenshots2/log_habit/remove_medication_screen.png) |
| **Medication details**<br>View details of medications. | **Medication**<br>Medication overview screen. | **Log your symptom**<br>Choose your symptom from category. | **Remove Medication**<br>Remove Medication from list. |
| ![Search food page](./Mobile-App/screenshots2/log_habit/search_food_screen.png) | ![Check Macros of Ingredient](./Mobile-App/screenshots2/log_habit/see_avocado_macros_1.png) | ![Check Macros of Ingredient](./Mobile-App/screenshots2/log_habit/see_avocado_macros_2.png) | ![Log your symptom](./Mobile-App/screenshots2/log_habit/symptoms_screen.png) |
| **Search food**<br>Search food screen. | **Check Macros of Ingredient**<br>Check your ingredient info and especially calories. | **Check Macros of Ingredient**<br>Check your ingredient info and especially macros. | **Log your symptom category**<br>Select your symptom category. |
